...
public class Game{
    ...
    public void createLevel(int levelnr, int score) {
    	...
    	if (levelnr <= maxLevel) {
    		/**
    		 *  generiert neues Levelobjekt
    		 */
    		level = new Level(this, levelnr, score);
    		/**
    		 *  startet die run-Methode des neuen Levels
    		 */
        	level.start();
            /**
             * startet die  Methode des Controlers um auf das Spielfeld zuschalten
             */
            controller.toPlayground();
    	}
    	else {
    		/**
    		 * startet die Methode des Controlers, um bei Spielende wieder auf den Startscrenn zu kommen
    		 */
